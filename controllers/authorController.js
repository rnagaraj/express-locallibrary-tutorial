...
exports.author_list = (req, res, next) => {
    Author
        ...
        if(err) {
            ...
            res.render('author_list', {title: 'Authors', author_list: author_list});
        }
    });
};
...
exports.author_create_post = [
    ...
    //Validate Fields
    body('first_name').isLength({min: 1}).trim().withMessage('First name required')
        .isAlphanumeric().withMessage('First name contains non alphanumeric characters'),

    body('family_name').isLength({min: 1}).trim().withMessage('Family Name required')
